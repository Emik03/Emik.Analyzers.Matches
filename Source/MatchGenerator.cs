...
[Generator]
public sealed class MatchGenerator() : FixedGenerator(
    $"Emik.{TypeName}.g.cs",
    $$"""
      // <auto-generated/>
      ...
      namespace Emik
      {
          ...
          internal sealed class {{TypeName}} : global::System.Attribute
          {
...
{
    /// <summary>The type name added by this generator.</summary>
    public const string TypeName = "MatchAttribute";
}
